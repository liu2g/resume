...
\begin{rSection}{EXPERIENCE}
    ...
    \begin{itemize}
        \itemsep -4pt {}
        \item \textbf{Collaborative Robots for Human-Robot Interaction} Design, implement and validate control and navigation systems of Cobots from simulation to real environments
