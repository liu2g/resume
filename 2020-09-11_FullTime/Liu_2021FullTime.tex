...
\begin{document}
	...
	\begin{rSection}{SKILLS}
		...
		\begin{tabular}{ @{} >{\bfseries}l @{\hspace{2ex}} l }
			...
			Embedded Systems & System design with microcontrollers, sensors and actuators, program in C for Atmel,	Assembly \\
			 &  for PIC, Verilog for FPGA	\\
			Prototyping and Testing &  On-board and PCB prototyping, developing test fixture and procedure, troubleshooting	\\
			Software Skills & Git, Linux, C/C++, C\#, Java, Python, MATLAB, SQLite database \\
